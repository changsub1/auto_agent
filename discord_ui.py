"""Discord views for human approval of generated plans."""
...
class PlanApprovalView(discord.ui.View):
    """Approval controls shown after a final plan is produced."""
...
class RevisionRequestModal(discord.ui.Modal, title="Plan revision request"):
